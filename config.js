...
const CONFIG = {
    scenes: {
        ...
        'cafe': {
            ...
            sounds: [
                { id: 'jazz', name: '氛圍爵士', url: './sounds/coffee jazz.mp3', volume: 0.15 },
                { id: 'coffemaker', name: '咖啡研磨', url: './sounds/coffee maker.mp3', volume: 0.15 }
            ],
        ...
        'bar': {
            ...
            sounds: [
                { id: 'barband', name: '酒吧樂隊', url: './sounds/bar band.mp3', volume: 0.3 },
                { id: 'barpeople', name: '吵雜人群', url: './sounds/bar people.mp3', volume: 0.2 },
                { id: 'barspace', name: '愉快乾杯', url: './sounds/bar space.mp3', volume: 0.4 }
            ],
        ...
        'rainy': {
            ...
            sounds: [
                ...
                { id: 'thunder', name: '電台音樂', url: './sounds/Swan.mp3', volume: 0.2 }
            ],
