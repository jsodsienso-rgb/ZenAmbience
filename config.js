...
const CONFIG = {
    scenes: {
        ...
        'cafe': {
            ...
            sounds: [
                { id: 'jazz', name: '氛圍爵士', url: './sound/jazz.mp3', volume: 0.15 }
            ],
        ...
        'bar': {
            ...
            sounds: [
                { id: 'bass', name: '低頻節奏', url: './sound/bar_vibes.mp3', volume: 0.2 }
            ],
        ...
        'rainy': {
            ...
            sounds: [
                { id: 'rain', name: '窗外雨聲', url: './sound/rain.mp3', volume: 0.5 },
                { id: 'thunder', name: '遠處雷鳴', url: './sound/thunder.mp3', volume: 0.2 }
            ],
        ...
        'urban': {
            ...
            sounds: [
                { id: 'traffic', name: '遠處車流', url: './sound/city.mp3', volume: 0.2 }
            ],
